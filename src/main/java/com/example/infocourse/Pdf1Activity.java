...
public class Pdf1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfview.fromAsset("Cours2.pdf").load();

    }
    private void initDownload() {
        String uri = "https://drive.google.com/file/d/1SP1pxH8BWQFk63nkz-YMst-cY9uTy1Gc/view?usp=share_link";
        download(getApplicationContext(), "Cours2", ".pdf", "Downloads", uri.trim());
    }
